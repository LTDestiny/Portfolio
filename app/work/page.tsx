...
const projects = [
  ...
  },
  {
    ...
    stack: [{ name: "React" }, { name: "Redux" }, { name: "CSS" }],
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                ...
                btnStyles="bg-accent hover:bg-accnet-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
                iconsStyles=""
              />
            </Swiper>
          </div>
